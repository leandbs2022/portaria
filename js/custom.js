...
const OPENAI_API_KEY = "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";
...
if (formPerguntaChat) {
    ...
    formPerguntaChat.addEventListener("submit", async (e) => {
        ...
        document.getElementById('btn-pergunta-chat').value = "Perguntar";
    });
}
