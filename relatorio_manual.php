...
$query = mysqli_query( $conn, "SELECT * FROM portaria INNER JOIN visitas ON portaria.rg = visitas.rg where visitas.filtro between '$inicio' AND '$final'" )
...
$dados .= "<img src=''><br>";
$dados .= "Data do relatório de $inicio a $final <br>";
$dados .= "<a href='http://lbscode.com.br/agencia/alpha/tela.php'> Voltar </a>";
$dados .= '</body>';
